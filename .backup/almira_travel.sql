...
CREATE TABLE `carousel_images` (
  ...
  `collection_photos_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `judul_banner` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `desc_banner` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
('1d6c5b32-1903-4d46-883b-e17959eb5410', 'eb5e3993-944b-4f2e-94c7-9e6c5d2a16f3', 'private', 'Discovery Your Next Journey With Almira Travel', 'lorem ipsum dolor si amet', '2025-03-01 05:49:37', '2025-03-01 05:49:37'),
...
('b6196d2e-8101-40d4-9c77-b5cb07970e0c', '10295bb8-1a95-442c-9c04-a7b807aa4821', 'travel', 'Discovery Your Next Journey With Almira Travel', 'Lorep ipsum', '2025-02-25 13:46:23', '2025-02-25 13:46:23'),
...
('10295bb8-1a95-442c-9c04-a7b807aa4821', 'm1c8V0j17QJaF5LqYfsKYQsUL46QybBXra5d2n2a.jpg', '2025-02-25 13:46:23', '2025-02-25 13:46:23'),
('7e8ba0f7-7ec9-43f8-b725-6426ddefcc41', 'afa1qQHVjm1fl7v9UypI3thhm25j8s3vTc2mDMQ2.png', '2025-02-26 16:13:12', '2025-02-26 16:13:12'),
('7e8ba0f7-7ec9-43f8-b725-6426ddefcc41', 'rrphxoSZxTnpWgYiKIwQpdnBaDZHtE93ckummHkq.png', '2025-02-26 16:13:12', '2025-02-26 16:13:12'),
('e35d31c7-8d29-4109-b330-4d0add22613c', 'J5hgm23i3dQpau6FL6tC9n2RL8WXPdOA4PhPBwaA.jpg', '2025-02-28 15:39:13', '2025-02-28 15:39:13'),
('e35d31c7-8d29-4109-b330-4d0add22613c', 'cBe7o4vGxANRb1tyg7dzQxC3QyAM8x8k48LQHqMq.jpg', '2025-02-28 15:39:13', '2025-02-28 15:39:13'),
('e35d31c7-8d29-4109-b330-4d0add22613c', 'L6rQnGYUry4K6Wu3UsjIb80hwZXLQ92J4fc5e8t1.jpg', '2025-02-28 15:39:13', '2025-02-28 15:39:13'),
('53631c17-b8bd-4deb-a88c-684d13e58d3c', 'KSlCTt3dmwcTyM2geLGiEqvClrPYho7qUAiDKhQK.jpg', '2025-02-28 16:44:13', '2025-02-28 16:44:13'),
('53631c17-b8bd-4deb-a88c-684d13e58d3c', 'ULTKKn3eUxMLlYw2C7nUskydq6vuEZPR2QfLPwUl.jpg', '2025-02-28 16:44:13', '2025-02-28 16:44:13'),
('53631c17-b8bd-4deb-a88c-684d13e58d3c', 'vs4MMJpfDdQprI7vk7vZtELsarzkeE9BJIXZNibr.jpg', '2025-02-28 16:44:13', '2025-02-28 16:44:13'),
('eb5e3993-944b-4f2e-94c7-9e6c5d2a16f3', 'oKRzn1HUWUJEDrB9aYT5BtrbVfWBCRrEcuxNooWS.webp', '2025-03-01 05:49:37', '2025-03-01 05:49:37');
...
CREATE TABLE `contact` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `wa` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(35, '2025_02_24_144030_travel_reguler', 4),
(36, '2022_08_25_141947_create_travel_reguler', 5);
...
CREATE TABLE `paket_tour` (
  ...
  `type_tour` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `trip_plan` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `best_offer` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `prepare` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sewa_mobil` (
  ...
  `review_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipe_mobil` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `travel_reguler`
--

CREATE TABLE `travel_reguler` (
  ...
  `price` int UNSIGNED NOT NULL,
  `trip` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `transport` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `door` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `travel_reguler`
--

INSERT INTO `travel_reguler` (`id`, `collection_photos_id`, `name`, `category`, `lokasi`, `price`, `trip`, `transport`, `door`, `slug`, `created_at`, `updated_at`) VALUES
('0fcf4b0a-7b91-4242-8980-88bb6f5dbc1b', '7e8ba0f7-7ec9-43f8-b725-6426ddefcc41', 'Nama Travel', 'Door to Door', 'Ngawi', 500000, '<p>test aja sih hehee</p>', '<ul><li>test</li></ul>', '<ul><li>test</li></ul>', 'nama-travel', '2025-02-26 16:13:12', '2025-02-26 16:13:12');
...
('31dc1d0a-0e73-470c-92d2-e3fd5fd3b505', 'Luettgen Kailey', 'admin@almiratravel.com', '2022-09-12 22:21:30', '$2y$10$fRcMHCU7IAavbkiNzKZE2OvWLXiKOTP84OCSiakaxv0sb7R9e90vS', 'MX3K3kinEV1OIrCMGMnLxsF5F00ITL57rEa123Mi93ppWR0dLgavVe8KtIyB', '2022-09-12 22:21:30', '2022-09-15 00:03:28');
...
--
-- Indexes for table `travel_reguler`
--
ALTER TABLE `travel_reguler`
  ADD PRIMARY KEY (`id`),
  ADD KEY `travel_reguler_collection_photos_id_index` (`collection_photos_id`);
