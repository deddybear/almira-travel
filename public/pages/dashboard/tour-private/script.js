...
$(document).ready(function() {
    ...
    $('#add').click(function() {
        ...
        indexTab = 0;
        $("#form")[0].reset();
        domModal('Menambahkan Post Paket Tour', 'Simpan & Tambah Post', 'Batalkan')
        method = "POST";
    });
    ...
    $('#form').on('submit', function (e) {
        ...
        $('#modal_form').modal('show')
        if (method == "POST") {
            url = `/tour-private/create`;
        } else if (method == "PATCH") {
            url = `/tour-private/update/${id}`;
