...
<div class="row p-4">
    <div class="col-12 col-md-9">
        <ul class="nav nav-tabs nav-justified"  id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="detail-tab" data-bs-toggle="tab" data-bs-target="#detail" href="#detail" role="tab" aria-controls="detail" aria-selected="true">Detail</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="trip-tab" data-bs-toggle="tab" data-bs-target="#trip" href="#trip" role="tab" aria-controls="trip" aria-selected="false">Trip Plan</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="offer-tab" data-bs-toggle="tab" data-bs-target="#offer" href="#offer" role="tab" aria-controls="offer" aria-selected="false">Best Offer</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="itinerary-tab" data-bs-toggle="tab" data-bs-target="#itinerary" href="#itinerary" role="tab" aria-controls="itinerary" aria-selected="false">Prepare</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="foto-tab" data-bs-toggle="tab" data-bs-target="#foto" href="#foto" role="tab" aria-controls="foto" aria-selected="false">Foto</a>
          </li>
        </ul>
