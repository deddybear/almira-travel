...
@section('js')
    <script src="{{ asset('/pages/dashboard/akun/script.js') }}"></script>
@endsection
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8 py-2">
                                                <input type="password"
                                                    ...
                                                    name="password_sekarang" placeholder="Password Baru" autocomplete="current-password">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8 py-2">
                                                <input type="password"
                                                    ...
                                                    name="password" placeholder="Password Baru" autocomplete="new-password">
                                                @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8 py-2">
                                                <input type="password"
                                                    ...
                                                    name="password_confirmation" placeholder="Ulangi Password Baru" autocomplete="new-password">
